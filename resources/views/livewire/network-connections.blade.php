    ...
    <div class="card shadow  text-white bg-dark">
      ...
      <div class="card-body">
        <div class="btn-group w-100 mb-3" role="group" aria-label="Basic radio toggle button group">
          <input wire:click="showTab('showSuggestion')" type="radio" class="btn-check" name="btnradio" id="btnradio1" autocomplete="off" checked>
          <label class="btn btn-outline-primary" for="btnradio1" id="get_suggestions_btn">Suggestions(<span class="suggestion_count"></span>)</label>

          <input wire:click="showTab('showRequest')" type="radio" class="btn-check" name="btnradio" id="btnradio2" autocomplete="off">
          ...
          <input wire:click="showTab('showReceivedRequest')" type="radio" class="btn-check" name="btnradio" id="btnradio3" autocomplete="off">
          ...
          <input wire:click="showTab('showConnections')" type="radio" class="btn-check" name="btnradio" id="btnradio4" autocomplete="off">
